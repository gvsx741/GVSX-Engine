 ...
 *
 *  @analysis cApp programmer error.  Initialize GLFW before calling any
 ...
 *
 *  @analysis cApp programmer error.  Ensure a context is current before
 ...
 *
 *  @analysis cApp programmer error.  Fix the offending call.
 */
